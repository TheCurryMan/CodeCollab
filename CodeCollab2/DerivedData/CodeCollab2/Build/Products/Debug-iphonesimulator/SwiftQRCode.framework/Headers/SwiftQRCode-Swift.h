...
SWIFT_CLASS("_TtC11SwiftQRCode6QRCode")
...
/// init function
///
/// \param autoRemoveSubLayers remove sub layers auto after detected code image
///
...
+ (UIImage * __nullable)generateImage:(NSString * __nonnull)stringValue avatarImage:(UIImage * __nullable)avatarImage avatarScale:(CGFloat)avatarScale;
